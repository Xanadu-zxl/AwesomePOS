    ...
    <el-row>
      <el-col :span="7" class="pos-order" id="order-list">
        <el-tabs>
          ...
          <el-tab-pane label="外卖">外卖来啦</el-tab-pane>
        </el-tabs>
      </el-col>
      <el-col :span="17">
        ...
        <div class="goods-type">
          <el-tabs>
            <el-tab-pane label="汉堡">
              <ul class="cookList">
                <li
                  v-for="(goods,goodsId) in type0Goods"
                  :key="goodsId"
            ...
            <el-tab-pane label="小食">
              <ul class="cookList">
                <li
                  v-for="(goods,goodsId) in type1Goods"
                  :key="goodsId"
                  @click="addOrderList(goods)"
                >
                  <span class="foodImg">
            ...
            <el-tab-pane label="饮料">
              <ul class="cookList">
                <li
                  v-for="(goods,goodsId) in type2Goods"
                  :key="goodsId"
                  @click="addOrderList(goods)"
                >
                  <span class="foodImg">
            ...
            <el-tab-pane label="套餐">
              <ul class="cookList">
                <li
                  v-for="(goods,goodsId) in type3Goods"
                  :key="goodsId"
                  @click="addOrderList(goods)"
                >
                  <span class="foodImg">
...
export default {
  ...
  created: function () {
    ...
    axios
      .get('http://localhost:8080/static/shopping.json')
      .then(response => {
